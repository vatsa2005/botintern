                ...
                switch (action.type) {
                    ...
                    case 'assert_text':
                        ...
                        if (txt.includes(action.value)) {
                            stepSpinner.succeed(chalk.green(`✅ Text Match: "${action.value}"`));
                            passedTests++;
                        } else {
                    ...
                    case 'assert_color':
                        stepSpinner.text = `Checking text color of "${action.element}"...`;
                        try {
                            ...
                            if (normalizedActual === expectedColor) {
                                stepSpinner.succeed(chalk.green(`✅ Color matches: ${action.color}`));
                                passedTests++;
                            } else {
                    ...
                    case 'assert_background':
                        stepSpinner.text = `Checking background color of "${action.element}"...`;
                        try {
                            ...
                            if (normalizedBg === expectedBg) {
                                stepSpinner.succeed(chalk.green(`✅ Background matches: ${action.color}`));
                                passedTests++;
                            } else {
                    ...
                    case 'assert_border_color':
                        stepSpinner.text = `Checking border color of "${action.element}"...`;
                        try {
                            ...
                            if (normalizedBorder === expectedBorder) {
                                stepSpinner.succeed(chalk.green(`✅ Border color matches: ${action.color}`));
                                passedTests++;
                            } else {
